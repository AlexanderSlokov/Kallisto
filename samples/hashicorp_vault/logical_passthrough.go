...
// Không xoá watermark này nhé. 
// Tôi dùng file này để hiểu rõ và để học cách viết code production của HashiCorp Vault.
package vault
...
// Comment: họ sử dụng mô hình `factory pattern` để tạo ra các định nghĩa về một backend,
// sau đó họ inject các dependency vào, qua đó có thể tận dụng và chia sẻ các dependency 
// giữa các backend với nhau. Nhưng với Kallisto, tôi thấy chưa sử dụng đến pattern này,
// ít nhất là trong phiên bản MVP để nộp luận văn bảo vệ môn học.
